...
<body>
    ...
    <ul>
	<center><img src="c.jpg"></<img></center>
	<%
         try
     		 {   
        	 	response.setHeader("Cache-Control", "no-cache,no-store,must-revalidate");
    	  		if(session.getAttribute("cid")==null)
    	  		{
   	        	...
   	        	String n1=(String)session.getAttribute("cid");
		 		...
		 		ResultSet rs=s.executeQuery("select * from CRegister where CID='"+n1+"'");
	        	 ...
	        	 { 
		     	 ...
		     	 out.println("<b>Name</b>  : "+rs.getString("NAME"));
		      	 out.println("<br></br>");
		     	 out.println("<b>Website</b> :"+rs.getString(4));
		     	 out.println("<br></br>");
		     	 out.println("<b>Email</b> : "+rs.getString(5));
		     	 out.println("<br></br>");
		     	 out.println("<b>Contact</b>:"+rs.getString(6));
		     	 out.println("<br></br>");
		      	 out.println("<b>Address</b>:"+rs.getString(7));
       ...
       <%
  		...
  		<li><a href="VCStudent.jsp" target="myframe">View Students</a></li>
  		<li><a href="Sendemail.jsp" target="myframe">Send Email</a></li>
